...
public class PageCritere extends PageMenu{
	...
	public int trouverLaLigneDuCritère(String nomDuProduit) throws Exception  {
	...
	public void cliquerBoutonModifierDuCritere(String nomDuProduit) throws Exception {
	...
	public void cliquerBoutonSuppressionDuCritere(String nomDuProduit) throws Exception {
